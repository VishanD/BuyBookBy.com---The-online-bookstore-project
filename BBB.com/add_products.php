	...
	<body>
		<div class="header">
			<div class="topnavigationBar" align="center">
				<nav>
					<a class="link2" href="sign_in.html">Sign Out</a>|
		...
		<div class="content">
			<p>
				<form class="bodyform" name="form2" method="post" action="add_product_query.php" >
					
					<h3>Fill this form to add new books to the database.<br /><br />Don't leave any fields empty. <br /> <br /></h3>
