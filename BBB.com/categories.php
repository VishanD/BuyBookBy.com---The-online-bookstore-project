...
<html lang="en">
	...
	<body>
		...
		?>
			...
			<div style="position: absolute;	top: 2100%; left:0%";>
			<form>
			<table>
				<tr>
	...
	$current_url = $current_url = $url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];

    
	$results = mysqli_query($mysqli,"SELECT * FROM CATEGORY ORDER BY catID ASC");
    ...
    if ($results) { 
        ...
        while($obj = mysqli_fetch_array($results))
        {
            ...
            echo '<a class="ang" href="booklist.php?requestCatID='.$obj['catID'].'">';

		//	echo '<div class="product-thumb"><img src="images/'.$obj['product_img_name'].'"></div>';
            echo '<div class="category-content"><h3>'.$obj['cat_name'].'</h3>';
         //	echo '<button class="add_to_cart"></button>';
			echo '</div>';
            echo '</a>';
            echo '</div>';
        }
