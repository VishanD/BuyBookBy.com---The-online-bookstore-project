...
<html lang="en">
	<head>
		...
		<script type="text/javascript" src="javascripts/signupvalid.js"></script>


		<title>	BuyBookBy.com | Sign Up	</title>
	...
	<body>
		...
		<form id="f3" action="formProcessing.php"  method="post"  onsubmit="return formValidate()">
		<table>
			<br /><h3>Create a new Account</h3><br />
			<tr>
				<td> Full Name : </td>
			...
			<tr>
				<td> City : </td>
				<td><input type="text" name="txte" id="txte" ></td>
			</tr><tr> </tr>
			<tr> </tr>
			<tr>
				<td> Zip Code : </td>
			...
			<tr>
				<td> State : </td>
				<td><input type="text" name="txtg" id="txtg"></td>
			</tr>
			<tr> </tr><tr> </tr>
			<tr>
				<td> Country : </td>
				<td>
					<select name="cust_address_country" id="cust_address_country" >
			...
			<tr>
				...
				<td><input type="text" name="txth" id="txth"></td>
			</tr>
			<tr> </tr><tr> </tr>
			<tr>
				<td> E-mail : </td>
				<td><input type="email" name="txti" id="txti"></td>
			</tr>
			<tr> </tr><tr> </tr>
			<tr>
				<td> Password : </td>
				<td><input type="password" name="txtj" id="txtj"/></td>
			</tr>
			<tr> </tr><tr> </tr>
			<tr>
				<td> Confirm Password : </td>
				<td><input type="password" name="txtk" id="txtk"/></td>
			</tr>
			<tr> </tr><tr> </tr>
			<tr>
				<td> Securiy Question : </td>
				<td>
			...
			<tr>
				...
				<td>	
					<input type="text" name="txtl" id="txtl">
				</td>
			</tr>
			...
			<tr>
				<td> </td>
				<td>
				<input type="reset" class="submit_button" name="res1" value="Reset">
				<input type="submit" class="submit_button" name="sub1" value="Create">
				</td>
			</tr>
		</table>
		</form> 
